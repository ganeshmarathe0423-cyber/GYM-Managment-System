				...
				<div class="col-lg-8">
					...
					<form class="singup-form contact-form" method="post">
						<div class="row">
							...
							<div class="col-md-6">
								<input type="text" name="email" id="email" placeholder="Your UserName" autocomplete="off" value="<?php echo $email;?>" required>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<input type="text" name="state" id="state" placeholder="Your City" autocomplete="off" value="<?php echo $state;?>" required>
							</div>
							<div class="col-md-6">
								<input type="text" name="city" id="city" placeholder="Your Address" autocomplete="off" value="<?php echo $city;?>" required>
							</div>
							<div class="col-md-6">
