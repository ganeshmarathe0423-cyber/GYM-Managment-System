...
<html lang="en">
  <head>
    ...
    <meta property="twitter:site" content="@GaneshMarathe">
    <meta property="twitter:creator" content="@GaneshMarathe">
    <!-- Open Graph Meta-->
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Vali Admin">
    <meta property="og:title" content="Vali - Free Bootstrap 4 admin theme">
    <meta property="og:url" content="http://GaneshMarathe.in/blog/vali-admin">
    <meta property="og:image" content="http://GaneshMarathe.in/blog/vali-admin/hero-social.png">
  ...
  <body class="app sidebar-mini rtl">
          ...
          <ul class="app-notification dropdown-menu dropdown-menu-right">
            ...
            <div class="app-notification__content">
              <li><a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-envelope fa-stack-1x fa-inverse"></i></span></span>
                  <div>
                    <p class="app-notification__message">Ram sent you a mail</p>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="https://s3.amazonaws.com/uifaces/faces/twitter/jsa/48.jpg" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Ganesh Marathe</p>
